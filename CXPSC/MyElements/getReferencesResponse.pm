...
package MyElements::getReferencesResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getReferencesResponse');
...
MyElements::getReferencesResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getReferencesResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::getReferencesResponse->new($data);
