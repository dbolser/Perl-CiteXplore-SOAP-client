...
package MyElements::getSupplementaryFilesResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getSupplementaryFilesResponse');
...
MyElements::getSupplementaryFilesResponse
...
=head2 new
 ...
 my $element = MyElements::getSupplementaryFilesResponse->new($data);
