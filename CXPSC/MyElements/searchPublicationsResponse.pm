...
package MyElements::searchPublicationsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('searchPublicationsResponse');
...
use base qw(
    ...
    MyTypes::searchPublicationsResponse
);
...
MyElements::searchPublicationsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
searchPublicationsResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::searchPublicationsResponse->new($data);
