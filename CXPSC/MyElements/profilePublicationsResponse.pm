...
package MyElements::profilePublicationsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('profilePublicationsResponse');
...
use base qw(
    ...
    MyTypes::profilePublicationsResponse
);
...
MyElements::profilePublicationsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
profilePublicationsResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::profilePublicationsResponse->new($data);
