...
package MyElements::getFulltextXMLResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getFulltextXMLResponse');
...
use base qw(
    ...
    MyTypes::getFulltextXMLResponse
);
...
MyElements::getFulltextXMLResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getFulltextXMLResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::getFulltextXMLResponse->new($data);
