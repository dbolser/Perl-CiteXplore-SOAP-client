...
package MyElements::listSearchFieldsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('listSearchFieldsResponse');
...
use base qw(
    ...
    MyTypes::listSearchFieldsResponse
);
...
MyElements::listSearchFieldsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
listSearchFieldsResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::listSearchFieldsResponse->new($data);
