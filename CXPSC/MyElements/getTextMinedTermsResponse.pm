...
package MyElements::getTextMinedTermsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getTextMinedTermsResponse');
...
use base qw(
    ...
    MyTypes::getTextMinedTermsResponse
);
...
MyElements::getTextMinedTermsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getTextMinedTermsResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::getTextMinedTermsResponse->new($data);
