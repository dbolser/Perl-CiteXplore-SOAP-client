...
package MyElements::getCitationsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getCitationsResponse');
...
MyElements::getCitationsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getCitationsResponse from the namespace http://webservice.cdb.ebi.ac.uk/.
...
=head2 new
 ...
 my $element = MyElements::getCitationsResponse->new($data);
